...
const DEFAULT_PROMPTS = {
    ...
    locationDescription: DEFAULT_LOCATION_DESCRIPTION_PROMPT,
    locationChanged: DEFAULT_LOCATION_CHANGED_PROMPT,
...
function openPromptsEditor() {
    ...
    tempPrompts = {
        ...
        locationDescription: extensionSettings.customLocationDescriptionPrompt || '',
        locationChanged: extensionSettings.customLocationChangedPrompt || '',
    ...
    $('#rpg-prompt-location-description').val(extensionSettings.customLocationDescriptionPrompt || DEFAULT_PROMPTS.locationDescription);
    $('#rpg-prompt-location-changed').val(extensionSettings.customLocationChangedPrompt || DEFAULT_PROMPTS.locationChanged);
...
function savePrompts() {
    ...
    extensionSettings.customLocationDescriptionPrompt = $('#rpg-prompt-location-description').val().trim();
    extensionSettings.customLocationChangedPrompt = $('#rpg-prompt-location-changed').val().trim();
...
function restorePromptToDefault(promptType) {
    ...
    switch(promptType) {
        ...
        case 'locationDescription':
            extensionSettings.customLocationDescriptionPrompt = '';
            break;
        case 'locationChanged':
            extensionSettings.customLocationChangedPrompt = '';
            break;
        case 'plotRandom':
...
function restoreAllToDefaults() {
    ...
    $('#rpg-prompt-location-description').val(DEFAULT_PROMPTS.locationDescription);
    $('#rpg-prompt-location-changed').val(DEFAULT_PROMPTS.locationChanged);
